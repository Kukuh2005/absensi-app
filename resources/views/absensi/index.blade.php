    ...
    <div class="row">
        <div class="col-md-12 bg-white mb-3 shadow">
            <div class="section-header p-3">
                <h4 class="card-title text-primary font-weight-bold">Absensi Siswa</h4>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="card card-tale mb-2" style="background-color: #2afa31">
                <div class="card-body">
                    ...
                    <a href="/absensi/{{$item->id}}" class="text-dark btn btn-sm" style="background-color: #77f7d3">Absensi</a>
                </div>
            </div>
        </div>
